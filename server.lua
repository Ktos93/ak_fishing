...
RegisterServerEvent("ak_fishing:AddFish")
AddEventHandler("ak_fishing:AddFish", function(name , weight)
...
RegisterServerEvent("ak_fishing:Sell")
AddEventHandler("ak_fishing:Sell", function()
	local _source = source
...
RegisterServerEvent("ak_fishing:RemoveBait")
AddEventHandler("ak_fishing:RemoveBait", function(name)
    local _source = source
...
AddEventHandler("RegisterUsableItem:p_baitBread01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_baitBread01x")
...
AddEventHandler("RegisterUsableItem:p_baitCorn01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_baitCorn01x")
end)

RegisterServerEvent("RegisterUsableItem:p_baitCheese01x")
AddEventHandler("RegisterUsableItem:p_baitCheese01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_baitCheese01x")
end)
...
AddEventHandler("RegisterUsableItem:p_finishedragonfly01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_finishedragonfly01x")
end)
...
AddEventHandler("RegisterUsableItem:p_baitCricket01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_baitCricket01x")
end)
...
AddEventHandler("RegisterUsableItem:p_FinisdFishlure01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_FinisdFishlure01x")
end)
...
AddEventHandler("RegisterUsableItem:p_finishdcrawd01x", function(source)
    local _source = source
    TriggerClientEvent("ak_fishing:UseBait", _source, "p_finishdcrawd01x")
end)
